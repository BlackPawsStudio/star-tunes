<?php
  ...
  switch (htmlspecialchars($_GET['create'])) {
    case 'user':
      $sql = 'INSERT INTO users (name, password, rating, marked, pfp) VALUES ('.htmlspecialchars($_GET['name']).', '.htmlspecialchars($_GET['password']).','.htmlspecialchars($_GET['rating']).', '.htmlspecialchars($_GET['marked']).', '.htmlspecialchars($_GET['pfp']).')';
